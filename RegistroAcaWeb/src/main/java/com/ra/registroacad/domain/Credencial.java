...
public class Credencial implements Serializable {
    ...
    public Credencial(String username, String password, Integer idestudiante) {
    ...
    public String toString() {
        return "Credencial{" + "username=" + username + ", password=" + password + ", activo=" + activo + ", idestudiante=" + idestudiante + '}';
    }
